		...
		<div class="card-body">
			<form action="lecciones/post_agregar" method="post">
				...
				<select name="id_materia" id="id_materia" class="form-control">
					...
					<div class="form-group">
						<label for="video">Video de la leccion</label>
					...
					<div class="form-group">
						<label for="status">Estado de la leccion</label>
						<select name="status" lid="status" class="form-control">
						...
						<button class="btn btn-success" type="submit">Guardar leccion</button>
					</form>
				</div>
			</div>
		</div> 
