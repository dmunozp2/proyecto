				...
				<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
					...
					<tbody>
						<?php foreach ($d->alumnos->rows as $a) : ?>
							<tr>
								...
								<td>
									<div class="btn-group">
										<a href="<?php echo 'alumnos/ver/' . $a->id; ?>" class="btn btn-sm btn-success"><i class="fas fa-pen"></i></a>
                    <?php if ($a-> status === 'suspendido') : ?>
                      ...
                      <?php else: ?>
                        ...
                        <?php endif; ?>
										<a href="<?php echo buildURL('alumnos/borrar/' . $a->id); ?>" class="btn btn btn-sm btn-danger confirmar"><i class="fas fa-trash"></i></a>
									</div>
								</td>
							</tr>
						<?php endforeach; ?>
