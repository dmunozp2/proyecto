					...
					<tbody>
						<?php foreach ($d->profesores->rows as $p) : ?>
							<tr>
								...
								<td>
									<div class="btn-group">
										<a href="<?php echo 'profesores/ver/' . $p->numero; ?>" class="btn btn-sm btn-success"><i class="fas fa-pen"></i></a>
										<a href="<?php echo buildURL('profesores/borrar/' . $p->id); ?>" class="btn btn btn-sm btn-danger confirmar"><i class="fas fa-trash"></i></a>
									</div>
								</td>
							</tr>
						<?php endforeach; ?>
