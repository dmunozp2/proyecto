...
<div class="card shadow mb-4">
	<div class="card-header py-3">
		<h6 class="m-0 font-weight-bold text-primary">
			...
			<a class="btn btn-success btn-sm" href="<?php echo buildURL('lecciones/agregar', ['id_materia' => $d->materia->id], false, false); ?>"><i class="fas fa-plus"></i>Agregar lección</a>
			</div>
		</h6>
	</div>
	<div class="card-body">
							...
							<li class="list-group-item">
								<div class="row">
									...
									<a href="<?php echo sprintf('lecciones/ver/%s', $l->id); ?>">
										<img src="<?php echo get_image('play.png'); ?>" alt="<?php echo $l->titulo; ?>" class="img-fluid" style="width: 30px;">
									</a>
									</div>
								<div class="col-xl-4">
		...
		<?php else : ?>
			<div class="py-5 text-center">
				<img src="<?php echo get_image('lecciones.png'); ?>" alt="No hay registros" style="width: 150px;">
				<p class="text-muted mt-4">No hay lecciones para esta materia.</p>
			</div>
		<?php endif; ?>
	</div>
</div>
