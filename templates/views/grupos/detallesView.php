			...
			<div class="collapse show" id="grupo_data">
				<div class="card-body">
					...
					<div class="form-group">
						...
						<textarea name="descripcion" id="descripcion" cols="10" rows="5" class="form-control" disabled><?php echo $d->g->descripcion; ?></textarea>
					</div>
						...
						<?php foreach ($d->g->materias as $m): ?>
							<li class="list-group-item">
								...
								<div class="btn-group float-right">
									...
									<a class="btn btn-success btn-sm" href="<?php echo sprintf('grupos/materia/%s', $m->id_materia); ?>"><i class="fas fa-pen"></i></a>
								</div>
							</li>
						<?php endforeach; ?>
					</ul>
