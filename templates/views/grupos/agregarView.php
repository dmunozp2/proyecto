...
<div class="row">
    <div class="col-xl-6">
        ...
        <div class="card shadow mb-4">
            ...
            <a href="#agregar_group_form" class="d-block card-header py-3" data-toggle="collapse" 
                role="button" aria-expanded="true" aria-controls="agregar_group_form">
                <h6 class="m-0 font-weight-bold text-primary">Completa el formulario</h6>
            </a>
            <!-- Card Content - Collapse -->
            <div class="collapse show" id="agregar_group_form">
                <div class="card-body">
